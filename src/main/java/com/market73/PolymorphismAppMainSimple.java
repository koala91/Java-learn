...
public class PolymorphismAppMainSimple {
    public static void main(String[] args) {
        ...
        // 就说明这个对象肯定是这个类型或者其子类的的一个实例（否则赋值会发生ClassCastException），总归有父类兜底。
